...
(function ($, ej, undefined) { 
    ...
    ej.widget("ejDropDownList", "ej.DropDownList", {
        ...
        _toArray: function (index, mode) {
            ...
            if ($.isArray(index)) items = index;
                ...
                if ((mode && (this.model.multiSelectMode == "visualmode" || this.model.multiSelectMode == "delimiter" || this.model.showCheckbox))) {
                    items = this._getUpdatedListData(index, mode);
        ...
        _selectUnSelectValue: function(val, selectValue,e, ignoreCasing){
             var items = (typeof val =="string") ? this._toArray(val, true): val;
                for (var k = 0; k < items.length; k++) {
                    for (var i = 0; i < this.listitems.length; i++) {
                        if (!$(this.listitems[i]).hasClass('e-disable') && (selectValue=="selectValue" || selectValue=="selectText")) {
                            ...
                            if(selectValue=="unselectText"){
                                ...
                                this._selectedValue = (this.unselectedTextValue == items[0]) || (ignoreCasing && this.unselectedTextValue.toString().toLowerCase() == items[k].toString().toLowerCase())
        ...
        _removeText: function (currentValue) {
            ...
            var hidVal = this._getUpdatedListData(this._visibleValue, (this.model.selectedIndices.length === this._visibleValue.length) ? true : false);
            this._unselectText = false;
        ...
        _getUpdatedListData: function (elementValue, value) {
            ...
            if (value) {				
                ...
                for (var i = 0; i < this.model.selectedIndices.length; i++) {
					...
					listValues = (typeof(elementValue) == "string") ? elementValue.split(this.model.delimiterChar): elementValue;     
            }
            else {
            ...
            if (!value) {
                listValues = (typeof(listValues) == "string") ? listValues.split(this.model.delimiterChar): listValues;
            }
            count = 0;
            ...
            val = ele[i] == "element" ? this._hiddenValue : currentValue;
                ...
                if (this[ele[i]][0].value && this[ele[i]][0].value != "") {
					...
					if( ele[i] == 'element' && $.inArray(val, splitedText) === -1){
                        ...
                        splitedText.push(val);
                        this._visibleValue = splitedText;
					}                    
        ...
        _OnSearchEnter: function (e) {
            if ((this._prevSearchValue != "" && this._prevSearchValue == this.inputSearch.val()) || (this._prevSearchValue == "" && this._prevSearchValue == this.inputSearch.val())) {
                return;
            } else {
        ...
        _updateSelectedIndexByValue: function (value) {
            ...
            var item = (typeof(value) == "string") ? this._toArray(value, true) : value;
