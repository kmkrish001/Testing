<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" EnableViewState="true" ViewStateMode="Enabled" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="WebApplication1._Default" %>

<%@ Register assembly="Syncfusion.EJ.Web" namespace="Syncfusion.JavaScript.Web" tagprefix="ej" %>
<%@ Register assembly="Syncfusion.EJ" namespace="Syncfusion.JavaScript.Web" tagprefix="ej" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">

   <div class="frame">
        <div class="control">
            <ej:DropDownList ID="DropDown" runat="server" WatermarkText="Select any value" Width="100%" ClientSideOnCreate="dropdownOnCreate">
                <Items>
                    <ej:DropDownListItem>
                        <ContentTemplate>
