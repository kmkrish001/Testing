    ...
    ej.widget("ejToolbar", "ej.Toolbar", {
        ...
        _wireEvents: function () {
            ...
            this._on(this.items, "mouseup", this._onItemClick);
			 this._on($(document), "click", this._onDocumentClick);
        },
      _onDocumentClick:function(e)
	  {
		  if(!e.target.classList.contains("e-toolbar") && !e.target.classList.contains("e-toolbar-res-arrow") && (!$(e.target).parents('.e-responsive-toolbar').length > 0))
			  this._eleClick = false;
	  },
