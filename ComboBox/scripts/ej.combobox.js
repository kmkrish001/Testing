...
(function ($) {
    var ejComboBox = (function (_super) {
        ...
        ejComboBox.prototype.renderPopup = function () {
            ...
            var popupEle = ej.buildTag('div#' + this.element[0].id + '_popup' + '.e-ddl e-popup e-widget ej1-combobox')[0];
        ...
        ejComboBox.prototype.createInput = function (args) {
            ...
            inputObject.container = ej.buildTag("span." + comboBoxClasses.input + " " + "e-widget ej1-combobox")[0];
