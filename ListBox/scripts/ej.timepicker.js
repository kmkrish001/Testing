...
(function ($, ej, undefined) {
    ...
    ej.widget("ejTimePicker", "ej.TimePicker", {
        ...
        _initialize: function () {
            ...
            if(!this.model.enableStrictMode) this._setMinMax();
            this._getAmPm();
        ...
        _render: function () {
            ...
            this._validateTimes();
            if(!this.model.enableStrictMode) this._createMinMaxObj();
        ...
        _elementClick: function (e) {
            if (!this.showDropdown && !this.model.enableStrictMode) this._showResult();
        },
        ...
        _targetFocus: function (e) {
            ...
            if (!this.model.showPopupButton && !this.model.enableStrictMode) this._showResult();
