(function ($, ej, undefined) {
    ...
    ej.widget("ejPager", "ej.Pager", {
        ...
        _renderDropdownlist: function () {
            ...
            proxy.pageInterval_wrap.on("keydown", function (e) {
                if(e.altKey && e.keyCode == 40){
                    ...
                    proxy._updatedFromDropDown(proxy, e);
                    proxy.$dropItem.hide();
        ...
        _updatedFromDropDown: function(proxy, e){
            proxy.refreshPager();
        ...
        _pagerClickHandler: function (e) {
            ...
            if(this._trigger("click", { "currentPage": this.model.currentPage, "event": e })) return;
                ...
                switch (prop) {
					...
					case "pageSize":
					    ...
					    if (this.model.pageSizeList && this.model.pageSizeList.length > 0) {
                            ...
                            this.$dropItem.find("li").each(function()  {
								var $li=$(this);  
