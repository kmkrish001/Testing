...
(function ($, ej, undefined) {
    ...
    ej.widget("ejColorPicker", "ej.ColorPicker", {
        ...
        _init: function (options) {
            ...
            this._previousOpacity = this._tempOpacity;
            if (this._tempValue) {
        ...
        _renderPopupPanelWrapper: function () {
			...
			this._presetTag.attr("id", this.element[0].id + "_split");
        ...
        _containerClick: function () {
            if (this.model.buttonMode == "split") this._trigger("select", { value: this.value(), RGBA: this.rgb });
        },
        ...
        _rgbaColor: function (code) {
            ...
            this._opacity.option('value', this._tempOpacity);
            this._previousOpacity = this.opacityValue();
            this.opacityValue(this._tempOpacity);
