...
(function ($, ej, undefined) { 
    ...
    ej.widget("ejDropDownList", "ej.DropDownList", {
        ...
        _removeText: function (currentValue) {
            ...
            if(!ej.isNullOrUndefined(listData[textField]) && $.inArray(listData[textField].toString(), hidVal)>=0) hidVal.splice($.inArray(listData[textField].toString(), hidVal), 1);
