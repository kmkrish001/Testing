...
(function ($, ej, undefined) {
    ...
    },
    {
        ...
        _setValues: function () {
            ...
            if (this.model.decimalPlaces >= 0) {
				if (this.model.minValue == -(Number.MAX_VALUE))
				{
				...
				{				
				 var decimalValue = Math.pow(10, this.model.decimalPlaces);
				 this.model.minValue = Math.ceil(this.model.minValue * decimalValue) / decimalValue;
                 this.model.maxValue = Math.floor(this.model.maxValue * decimalValue) / decimalValue;
				}
            }
            if (this.model.minValue != -(Number.MAX_VALUE)) this._startValue = this.model.minValue;
