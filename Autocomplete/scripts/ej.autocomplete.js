       ...
       selectValueByKey: function (key) {
        ...
        _valueToTextBox: function (currentValue, data, flag) {
         ...
         if (this.model.multiSelectMode == "visualmode") {
             ...
             if (typeof currentValue == "number") currentValue = this._textFormateString(currentValue);
                ...
                if((this.model.showPopupButton)&&(this._ulBox.parent()[0].scrollHeight!=0)) this.dropdownbutton.css("height",this.model.height);				
				}
        ...
        _onScroll: function(e){
            ...
            if (currentScrollTop > this.lastScrollTop){
                this.dropdownbutton[0].style.top = (this.container[0].scrollHeight - parseInt(this.model.height))+"px";
            } else {
                this.dropdownbutton[0].style.top = this.container[0].scrollTop + "px";
            }
            this.lastScrollTop = currentScrollTop;
            this.dropdownbutton[0].style.float = "right";
        },
        ...
        _fetchRemoteDat: function (source) {
            ...
            queryPromise.fail(function (e) {
                ...
                if (!proxy._isServerFiltering) { proxy._getFilteredList(e.result, e); }
                else { proxy.suggestionListItems = e.result; }
        ...
        _OnDropdownClick: function (e) {
            if (this.model.enabled && !this.model.readOnly) {
				...
				else if((this._queryString && this._queryString.length > 0) || (this.value())&& this.model.multiSelectMode != "visualmode")
				{
        ...
        _wireEvents: function () {
            ...
            this._on(this.container, "scroll", this._onScroll);
        }
    });
